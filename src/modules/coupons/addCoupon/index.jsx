                ...
                <form>
                  <div className="form-group">
                    ...
                    {locale === "ar" ? (
                      ...
                      <div>
                        <label className="f-b fs-5">Coupon Title</label>
                        <input
                          type="text"
                          className="form-control"
                  ...
                  <div className="form-group">
                    <label>{pathOr("", [locale, "Coupons", "couponType"], t)}</label>
                    <select
                  ...
                  <div className="d-flex align-items-center justify-content-between flex-wrap mb-3">
                    <span className="f-b">{pathOr("", [locale, "Coupons", "isFreeDelivery"], t)}</span>
                  ...
                  <div className="d-flex align-items-center justify-content-between flex-wrap mb-3">
                    <span className="f-b">{pathOr("", [locale, "Coupons", "discountedExcluded"], t)}</span>
                    <div className="form-check form-switch p-0 m-0">
                      <input
                        className="form-check-input m-0"
                        type="checkbox"
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group">
                        <label>{pathOr("", [locale, "Coupons", "numberOfTimesEveryone"], t)}</label>
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        <label>{pathOr("", [locale, "Coupons", "numberOfTimesCustomer"], t)}</label>
                        <div className="inpt_numb">
