...
const Branches = ({ branches: b = [] }) => {
  ...
  const handleEditBranch = async (id, isActive, values) => {
    ...
    try {
      const values = { id: id , isActive: isActive, nameAr: values?.name, nameEn: values?.name, location: values?.streetName, regionCode: values?.regionCode, lng: 'Test', lat: 'Test', streetName: 'street Name' }
    ...
    <div className="body-content">
      <div>
        <div className="d-flex align-items-center justify-content-between mb-4 gap-2 flex-wrap">
          <h6 className="f-b m-0">الفروع ({branches?.length})</h6>
